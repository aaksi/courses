...
const meanScore = (...args) => {
  ...
  return args.reduce((acc, val) => acc + val / args.length, 0).toFixed(2)
}
...
console.log(
  meanScore(meanScore(...scores1, ...scores2, ...scores3))
)
// 2.59

console.log(meanScore(meanScore(...scores1, ...scores2, ...scores3, ...scores4)))
// Все аргументы в вызове функции должны быть числами!
